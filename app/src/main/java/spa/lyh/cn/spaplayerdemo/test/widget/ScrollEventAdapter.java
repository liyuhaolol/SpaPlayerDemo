...
import static spa.lyh.cn.spaplayerdemo.test.widget.ViewPager3.ORIENTATION_HORIZONTAL;
import static spa.lyh.cn.spaplayerdemo.test.widget.ViewPager3.SCROLL_STATE_DRAGGING;
import static spa.lyh.cn.spaplayerdemo.test.widget.ViewPager3.SCROLL_STATE_IDLE;
import static spa.lyh.cn.spaplayerdemo.test.widget.ViewPager3.SCROLL_STATE_SETTLING;
...
final class ScrollEventAdapter extends RecyclerView.OnScrollListener{
    ...
    private ViewPager3.OnPageChangeCallback mCallback;
    private final @NonNull
    ViewPager3 mViewPager;
    ...
    private @ViewPager3.ScrollState int mScrollState;
    ...
    ScrollEventAdapter(@NonNull ViewPager3 viewPager) {
    ...
    private void startDrag(boolean isFakeDrag) {
        ...
        if (mTarget != NO_POSITION) {
            ...
            // Update "drag start page" to reflect the page that ViewPager3 thinks it is at
            mDragStartPosition = mTarget;
            // Reset target because drags have no target until released
            mTarget = NO_POSITION;
        } else if (mDragStartPosition == NO_POSITION) {
            // ViewPager3 was at rest, set "drag start page" to current page
    ...
    void setOnPageChangeCallback(ViewPager3.OnPageChangeCallback callback) {
        mCallback = callback;
    }
    ...
    /**
     * @return {@code true} if the ViewPager3 is being dragged. Returns {@code false} from the
     *         moment the ViewPager3 starts settling or goes idle.
     */
    boolean isDragging() {
     ...
     *         {@link ViewPager3#endFakeDrag()} is called.
     */
     ...
     * the ViewPager is settling towards its {@link ViewPager3#getCurrentItem() current item}, or
    ...
    private void dispatchStateChanged(@ViewPager3.ScrollState int state) {
